...
class Web3Provider extends Component {
  ...
  /** Injects web3 and userData to the child **/
  getChildContext() {
    console.log('Inyecting context')
    return {
  ...
  render() {
    if (this.state.render && this.state.web3 && this.state.userData.authenticated) {
      console.log('Returning children props ', this.props.children)
      /** TODO CHANGE IN THE FUTURE FOR A BETTER IMPLEMENTATION **/
